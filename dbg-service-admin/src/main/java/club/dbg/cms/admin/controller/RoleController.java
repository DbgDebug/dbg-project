...
public class RoleController {
    ...
    public ResponseEntity<ResponseResultDTO> getRoleList(
        ...
        return ResponseEntity.ok(new ResponseResultDTO(roleService.getRoleList(roleName, page, pageSize)));
    }

    @RequestMapping(value = "add_role", name = "添加角色", method = RequestMethod.POST)
    public ResponseEntity<ResponseResultDTO> addRole(
        ...
        return ResponseEntity.ok(new ResponseResultDTO(roleService.addRole(operator, role)));
    }

    @RequestMapping(value = "edit_role", name = "编辑角色", method = RequestMethod.POST)
    public ResponseEntity<ResponseResultDTO> editRole(MyHttpServletRequest request,
        ...
        role.setPermissionSet(tmpSet);
        return ResponseEntity.ok(new ResponseResultDTO(roleService.editRole(operator, role)));
    }

    @RequestMapping(value = "delete_role", name = "删除角色", method = RequestMethod.POST)
    public ResponseEntity<ResponseResultDTO> deleteRole(MyHttpServletRequest request,
                                                        @RequestParam("id") Integer id) {
        Operator operator = request.getOperator();
        return ResponseEntity.ok(new ResponseResultDTO(roleService.deleteRole(operator, id)));
    }
}
