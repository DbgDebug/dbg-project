...
public class DouYuTest {
    @Test
    public void douyuTest() throws IOException, InterruptedException {
        Socket socket = new Socket("openbarrage.douyutv.com", 8601);

        // 心跳包
        String bh = "type@=keeplive/tick@=";

        // 发送登录请求(登入9999房间)
        String loginCMD = "type@=loginreq/roomid@=5303276/";
        ...
        // 加入弹幕分组开始接收弹幕
        String joinGroupCMD =  "type@=joingroup/rid@=5303276/gid@=-9999/";
